...
public class MindMarkdownSimpleAtributo extends MindMarkdownAtributo{
//VARS GLOBAIS
...
//ATRIBUTOS
	private MindMarkdownAtributo atributo=new MindMarkdownAtributo();
		public void setAtributo(Object nome,Object valor){atributo.addAttribute(nome,valor);}
//MAIN
	public MindMarkdownSimpleAtributo(){}
//FUNCS
