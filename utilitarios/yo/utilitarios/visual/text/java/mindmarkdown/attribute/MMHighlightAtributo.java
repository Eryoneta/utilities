...
public class MMHighlightAtributo extends MindMarkAtributo{
//TAGS
...
//MAIN
	public MMHighlightAtributo(){
		...
		StyleConstants.setBackground(this,BACKGROUND_COLOR);
	}
//FUNCS
	public static void applyStyle(MindMarkDocumento doc){
		final MMHighlightAtributo atributo=new MMHighlightAtributo();
