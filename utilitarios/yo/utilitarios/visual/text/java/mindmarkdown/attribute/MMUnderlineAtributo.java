...
public class MMUnderlineAtributo extends MindMarkAtributo{
//TAGS
	private final static String TEXT_TAG=Pattern.quote("_");
	private final static String MULTILINE_TAG=Pattern.quote("___");
//DEFINITIONS
...
//FUNCS
	public static void applyStyle(MindMarkDocumento doc){
		final MMUnderlineAtributo atributo=new MMUnderlineAtributo();
